...
-- Spawn in a reserved guid band for this module (60020000-60029999): high enough
...
DELETE FROM `creature` WHERE `guid` = 60020000;
INSERT INTO `creature` (`guid`, `id1`, `map`, `position_x`, `position_y`, `position_z`, `orientation`) VALUES
(60020000, @Entry, 571, 5822.258, 538.113, 651.134, 1.8205); -- Dalaran